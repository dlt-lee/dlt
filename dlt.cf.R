...
tests.ab<-data.frame(tsn1,tsn2,tsn3,
                     ...
                     b2.2,b2.2,
                     b2.3,b2.3)
testPredictions.a1<-predict(cforest.a1,tests.ab)
testPredictions.a2<-predict(cforest.a2,tests.ab)
testPredictions.a3<-predict(cforest.a3,tests.ab)
testPredictions.a4<-predict(cforest.a4,tests.ab)
testPredictions.a5<-predict(cforest.a5,tests.ab)
