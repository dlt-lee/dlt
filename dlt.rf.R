...
set.seed(100)
randomForest.a1<-train(resa1~a1.1+a2.1+a3.1+a4.1+a5.1+
                         a1.2+a2.2+a3.2+a4.2+a5.2+
                         a1.3+a2.3+a3.3+a4.3+a5.3+
                       ...
                       importance = TRUE,
                       ntrees=1000)
plot(randomForest.a1,main="a1")
randomForest.a2<-train(resa2~a1.1+a2.1+a3.1+a4.1+a5.1+
                         a1.2+a2.2+a3.2+a4.2+a5.2+
                         a1.3+a2.3+a3.3+a4.3+a5.3+
                         b1.1+b2.1+b2.2+b2.2+b2.3+b2.3,
                       data = trains.a2,
                       ...
                       importance = TRUE,
                       ntrees=1000)
plot(randomForest.a2,main="a2")
randomForest.a3<-train(resa3~a1.1+a2.1+a3.1+a4.1+a5.1+
                         a1.2+a2.2+a3.2+a4.2+a5.2+
                         a1.3+a2.3+a3.3+a4.3+a5.3+
                         b1.1+b2.1+b2.2+b2.2+b2.3+b2.3,
                       data = trains.a3,
                       ...
                       importance = TRUE,
                       ntrees=1000)
plot(randomForest.a3,main="a3")
randomForest.a4<-train(resa4~a1.1+a2.1+a3.1+a4.1+a5.1+
                         a1.2+a2.2+a3.2+a4.2+a5.2+
                         a1.3+a2.3+a3.3+a4.3+a5.3+
                         b1.1+b2.1+b2.2+b2.2+b2.3+b2.3,
                       data = trains.a4,
                       ...
                       importance = TRUE,
                       ntrees=1000)
plot(randomForest.a4,main="a4")
randomForest.a5<-train(resa5~a1.1+a2.1+a3.1+a4.1+a5.1+
                         a1.2+a2.2+a3.2+a4.2+a5.2+
                         a1.3+a2.3+a3.3+a4.3+a5.3+
                         b1.1+b2.1+b2.2+b2.2+b2.3+b2.3,
                       data = trains.a5,
                       ...
                       importance = TRUE,
                       ntrees=1000)
plot(randomForest.a5,main="a5")
randomForest.b1<-train(resb1~a1.1+a2.1+a3.1+a4.1+a5.1+
                         a1.2+a2.2+a3.2+a4.2+a5.2+
                         a1.3+a2.3+a3.3+a4.3+a5.3+
                         b1.1+b2.1+b2.2+b2.2+b2.3+b2.3,
                       data = trains.b1,
                       ...
                       importance = TRUE,
                       ntrees=1000)
plot(randomForest.b1,main="b1")
randomForest.b2<-train(resb2~a1.1+a2.1+a3.1+a4.1+a5.1+
                         a1.2+a2.2+a3.2+a4.2+a5.2+
                         a1.3+a2.3+a3.3+a4.3+a5.3+
                         b1.1+b2.1+b2.2+b2.2+b2.3+b2.3,
                       data = trains.b2,
...
tests.ab<-data.frame(tsn1,tsn2,tsn3,
                     ...
                     b2.2,b2.2,
                     b2.3,b2.3)
testPredictions.a1<-predict(randomForest.a1,tests.ab)
testPredictions.a2<-predict(randomForest.a2,tests.ab)
testPredictions.a3<-predict(randomForest.a3,tests.ab)
testPredictions.a4<-predict(randomForest.a4,tests.ab)
