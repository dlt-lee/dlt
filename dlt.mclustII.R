...
c(p.m.a11[which(n.m.a1==01),2],
  p.m.a22[which(n.m.a2==06),2],
  p.m.a33[which(n.m.a3==09),2],
  p.m.a44[which(n.m.a4==15),2],
  p.m.a55[which(n.m.a5==26),2],
  p.m.b11[which(n.m.b1==08),2],
  p.m.b22[which(n.m.b2==09),2])
...
p.m.dlt<-c(18023,3,0.00000000,0.04712042,0.05250000,0.05434783,0.11538462,0.13953488,0.05797101,
           ...
           18077,6,0.13846154,0.06451613,0.03500000,0.04854369,0.05128205,0.06880734,0.11111111)
