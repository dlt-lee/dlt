...
c(p.m.a11[which(n.m.a1==03),2],
  p.m.a22[which(n.m.a2==09),2],
  p.m.a33[which(n.m.a3==12),2],
  p.m.a44[which(n.m.a4==28),2],
  p.m.a55[which(n.m.a5==30),2],
  p.m.b11[which(n.m.b1==04),2],
  p.m.b22[which(n.m.b2==12),2])
