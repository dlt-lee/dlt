dlt_sum_L2<-function(data_org,n) {
  ...
  bst.a1<-xgboost(data = trains.T.a1,label = res_m[,1],nrounds = 300,print_every_n = 300L,params = list(tree_method = 'gpu_hist'))
  bst.a2<-xgboost(data = trains.T.a2,label = res_m[,2],nrounds = 300,print_every_n = 300L,params = list(tree_method = '_hist'))
  ...
  bst.b2<-xgboost(data = trains.T.b2,label = res_m[,7],nrounds = 300,print_every_n = 300L,params = list(tree_method = 'gpu_hist'))
