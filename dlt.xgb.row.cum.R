#data<-data.for.xgb.row
dlt.xgb.row.cum <- function(data){
  n<-300
  ...
  a1<-pre.final.data$a1.row
  a2<-pre.final.data$a2.row
  a3<-pre.final.data$a3.row
  a4<-pre.final.data$a4.row
  a5<-pre.final.data$a5.row
  b1<-pre.final.data$b1.row
  b2<-pre.final.data$b2.row
