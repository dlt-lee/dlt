...
count<-dim(dlt)[1]
n<-300
dlt.clu.xgb.IX <- function(data,count,n) {
  library(xgboost)
  ...
  trains.T.a1<-Matrix(as.matrix(trains.a1[,4:12]),sparse=T)
  trains.T.a2<-Matrix(as.matrix(trains.a2[,4:12]),sparse=T)
  trains.T.a3<-Matrix(as.matrix(trains.a3[,4:12]),sparse=T)
  trains.T.a4<-Matrix(as.matrix(trains.a4[,4:12]),sparse=T)
  trains.T.a5<-Matrix(as.matrix(trains.a5[,4:12]),sparse=T)
  trains.T.b1<-Matrix(as.matrix(trains.b1[,4:12]),sparse=T)
  trains.T.b2<-Matrix(as.matrix(trains.b2[,4:12]),sparse=T)
  ...
  tests.T.a1<-Matrix(as.matrix(tests.a1[,4:12]),sparse=T)
  tests.T.a2<-Matrix(as.matrix(tests.a2[,4:12]),sparse=T)
  tests.T.a3<-Matrix(as.matrix(tests.a3[,4:12]),sparse=T)
  tests.T.a4<-Matrix(as.matrix(tests.a4[,4:12]),sparse=T)
  tests.T.a5<-Matrix(as.matrix(tests.a5[,4:12]),sparse=T)
  tests.T.b1<-Matrix(as.matrix(tests.b1[,4:12]),sparse=T)
  tests.T.b2<-Matrix(as.matrix(tests.b2[,4:12]),sparse=T)
