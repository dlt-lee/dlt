...
ab.result.a1<-c(tail(ab.1.row$a1,1),tail(ab.2.row$a1,1),tail(ab.3.row$a1,1),tail(ab.6.row$a1,1),
...
ab.result.a2<-c(tail(ab.1.row$a2,1),tail(ab.2.row$a2,1),tail(ab.3.row$a2,1),tail(ab.6.row$a2,1),
...
ab.result.a3<-c(tail(ab.1.row$a3,1),tail(ab.2.row$a3,1),tail(ab.3.row$a3,1),tail(ab.6.row$a3,1),
...
ab.result.a4<-c(tail(ab.1.row$a4,1),tail(ab.2.row$a4,1),tail(ab.3.row$a4,1),tail(ab.6.row$a4,1),
...
ab.result.a5<-c(tail(ab.1.row$a5,1),tail(ab.2.row$a5,1),tail(ab.3.row$a5,1),tail(ab.6.row$a5,1),
...
ab.result.b1<-c(tail(ab.1.row$b1,1),tail(ab.2.row$b1,1),tail(ab.3.row$b1,1),tail(ab.6.row$b1,1),
...
ab.result.b2<-c(tail(ab.1.row$b2,1),tail(ab.2.row$b2,1),tail(ab.3.row$b2,1),tail(ab.6.row$b2,1),
...
sort(table(ab.result.a3[1:9]))
sort(table(ab.result.a4[1:9]))
