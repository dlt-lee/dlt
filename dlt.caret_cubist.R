...
#dlt.caret_cubist <- function(data,count) {
  ...
  cubistTuned.b2<-train(resb2~
                        ...
                        trControl=trainControl(method = "repeatedcv",
                                               repeats = n.r,
                                               number = n.n))
  print(plot(cubistTuned.b2,main="cubist.b2"))
  ...
  tests.ab<-data.frame(tsn1,tsn2,tsn3,
                       ...
                       b1.2,b2.2,
                       b1.3,b2.3)
  testPredictions.a1<-predict(cubistTuned.a1,tests.ab)
  testPredictions.a2<-predict(cubistTuned.a2,tests.ab)
  testPredictions.a3<-predict(cubistTuned.a3,tests.ab)
  testPredictions.a4<-predict(cubistTuned.a4,tests.ab)
  ...
  result.model<-list(cubistTuned.a1,
                     cubistTuned.a2,
                     cubistTuned.a3,
                     cubistTuned.a4,
                     cubistTuned.a5,
