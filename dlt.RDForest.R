...
rf.a1 = randomForest(r.a1 ~ a1+a2+a3+a4+a5,data = trainset.a1,importance = T)
p.a1 = predict(rf.a1,testset.a)
#A2:
r.a2<-results[,5]
trainset.a2<-cbind(trains[,4:8],r.a2)
rf.a2 = randomForest(r.a2 ~ a1+a2+a3+a4+a5,data = trainset.a2,importance = T)
p.a2 = predict(rf.a2,testset.a)
#A3:
r.a3<-results[,6]
trainset.a3<-cbind(trains[,4:8],r.a3)
rf.a3 = randomForest(r.a3 ~ a1+a2+a3+a4+a5,data = trainset.a3,importance = T)
p.a3 = predict(rf.a3,testset.a)
#A4:
r.a4<-results[,7]
trainset.a4<-cbind(trains[,4:8],r.a4)
rf.a4 = randomForest(r.a4 ~ a1+a2+a3+a4+a5,data = trainset.a4,importance = T)
p.a4 = predict(rf.a4,testset.a)
#A5:
r.a5<-results[,8]
trainset.a5<-cbind(trains[,4:8],r.a5)
rf.a5 = randomForest(r.a5 ~ a1+a2+a3+a4+a5,data = trainset.a5,importance = T)
...
rf.b1 = randomForest(r.b1 ~ b1+b2,data = trainset.b1,importance = T)
p.b1 = predict(rf.b1,testset.b)
#B2:
r.b2<-results.b[,10]
trainset.b2<-cbind(trains.b[,9:10],r.b2)
rf.b2 = randomForest(r.b2 ~ b1+b2,data = trainset.b2,importance = T)
