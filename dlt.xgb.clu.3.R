dlt.xgb.clu.3 <- function(trains,d_o) {
  ...
  bst.a2<-xgboost(data = trains.T[,c(44,51,58)],label = trains$res.a2,nrounds = 300,print_every_n = 300L,params = list(tree_method = 'gpu_hist'))
  ...
  bst.b1<-xgboost(data = trains.T[,c(48,55,62)],label = trains$res.b1,nrounds = 300,print_every_n = 300L,params = list(tree_method = 'gpu_hist'))
