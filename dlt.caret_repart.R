...
#dlt.caret_repart <- function(data,count) {
  ...
  rpartModel.b2<-train(resb2~
                       ...
                       trControl=trainControl(method = "repeatedcv",
                                              repeats = n.r,
                                              number = n.n))
  print(plot(rpartModel.b2,main="rpart.b2"))
  ...
  tests.ab<-data.frame(tsn1,tsn2,tsn3,
                       ...
                       b1.2,b2.2,
                       b1.3,b2.3)
  testPredictions.a1<-predict(rpartModel.a1,tests.ab)
  testPredictions.a2<-predict(rpartModel.a2,tests.ab)
  testPredictions.a3<-predict(rpartModel.a3,tests.ab)
  testPredictions.a4<-predict(rpartModel.a4,tests.ab)
  ...
  result.model<-list(rpartModel.a1,
                     rpartModel.a2,
                     rpartModel.a3,
                     rpartModel.a4,
                     rpartModel.a5,
