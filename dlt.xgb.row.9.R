dlt.xgb.row.9<-function(trains,d_o) {
  ...
  if (threads <= 8) {
    ...
    bst.a4<-xgboost(data = trains.T,label = trains$res.a4,nrounds = 300,print_every_n = 300L,params = list(tree_method = 'hist'))
    bst.a5<-xgboost(data = trains.T,label = trains$res.a5,nrounds = 300,print_every_n = 300L,params = list(tree_method = 'hist'))
    bst.b1<-xgboost(data = trains.T,label = trains$res.b1,nrounds = 300,print_every_n = 300L,params = list(tree_method = 'hist'))
    bst.b2<-xgboost(data = trains.T,label = trains$res.b2,nrounds = 300,print_every_n = 300L,params = list(tree_method = 'hist'))
    
  }else{
    bst.a1<-xgboost(data = trains.T,label = trains$res.a1,nrounds = 300,print_every_n = 300L,params = list(tree_method = 'hist',nthread=number_of_core))
    bst.a2<-xgboost(data = trains.T,label = trains$res.a2,nrounds = 300,print_every_n = 300L,params = list(tree_method = 'hist',nthread=number_of_core))
    bst.a3<-xgboost(data = trains.T,label = trains$res.a3,nrounds = 300,print_every_n = 300L,params = list(tree_method = 'hist',nthread=number_of_core))
    ...
    bst.b2<-xgboost(data = trains.T,label = trains$res.b2,nrounds = 300,print_every_n = 300L,params = list(tree_method = 'hist',nthread=number_of_core))
