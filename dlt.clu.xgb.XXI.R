...
dlt.clu.xgb.XXI <- function(data,count,n) {
  ...
  trains.a5<-data.frame(trn1,trn2,trn3,
                        ...
                        a5.11,a5.12,a5.13,a5.14,a5.15,
                        a5.16,a5.17,a5.18,a5.19,a5.20,
                        a5.21,
                        resa5)
  ...
  tests.T.a3<-Matrix(as.matrix(tests.a3[,4:24]),sparse=T)
  tests.T.a4<-Matrix(as.matrix(tests.a4[,4:24]),sparse=T)
  tests.T.a5<-Matrix(as.matrix(tests.a5[,4:24]),sparse=T)
  tests.T.b1<-Matrix(as.matrix(tests.b1[,4:24]),sparse=T)
  tests.T.b2<-Matrix(as.matrix(tests.b2[,4:24]),sparse=T)
