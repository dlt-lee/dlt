...
#dlt.caret_treebag <- function(data,count) {
  ...
  treebagModel.a3<-train(resa3~
                         ...
                         trControl=trainControl(method = "repeatedcv",
                                                repeats = n.r,
                                                number = n.n))
  treebagModel.a4<-train(resa4~a1.1+a2.1+a3.1+a4.1+a5.1+
                           a1.2+a2.2+a3.2+a4.2+a5.2+
                           a1.3+a2.3+a3.3+a4.3+a5.3+
  ...
  tests.ab<-data.frame(tsn1,tsn2,tsn3,
                       ...
                       b1.2,b2.2,
                       b1.3,b2.3)
  testPredictions.a1<-predict(treebagModel.a1,tests.ab)
  testPredictions.a2<-predict(treebagModel.a2,tests.ab)
  testPredictions.a3<-predict(treebagModel.a3,tests.ab)
  testPredictions.a4<-predict(treebagModel.a4,tests.ab)
  ...
  result.model<-list(treebagModel.a1,
                     treebagModel.a2,
                     treebagModel.a3,
                     treebagModel.a4,
                     treebagModel.a5,
