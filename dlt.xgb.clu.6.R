dlt.xgb.clu.6<-function(trains,d_o) {
  ...
  bst.a2<-xgboost(data = trains.T[,c(23,30,37,44,51,58)],label = trains$res.a2,nrounds = 300,print_every_n = 300L,params = list(tree_method = 'gpu_hist'))
  ...
  bst.b1<-xgboost(data = trains.T[,c(27,34,41,48,55,62)],label = trains$res.b1,nrounds = 300,print_every_n = 300L,params = list(tree_method = 'gpu_hist'))
