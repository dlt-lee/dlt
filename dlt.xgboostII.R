...
#trains.a<-data.frame(trn1,trn2,tra1.1,tra2.1,tra3.1,tra4.1,tra5.1,tra1.2,tra2.2,tra3.2,tra4.2,tra5.2)
#trains<-cbind(trn,trains_2$n,trains_1[,4:8],trains_2[,4:8])
...
#tests.a<-data.frame(tsn1,tsn2,tsa1.1,tsa2.1,tsa3.1,tsa4.1,tsa5.1,tsa1.2,tsa2.2,tsa3.1,tsa4.1,tsa5.1)
#tests<-cbind(tsn,tail(dlt,2)[1,4:8],tail(dlt,2)[2,4:8])

#Convert
#dlt_trains.a<-Matrix::sparse.model.matrix(trn1+trn2 ~ .-1, data = trains.a)
#dlt_tests.a<-Matrix::sparse.model.matrix(tsn1+tsn2 ~ .-1, data = tests.a)
...
#dlt_trains.a1<-dlt.convert(trains.a1$trn2,trains.a1[,3:4],3)[,2:12]
#dlt_tests.a1<-dlt.convert(tests.a1$tsn2,tests.a1[,3:4],3)[,2:12]
#dlt_trains.a2<-dlt.convert(trains.a2$trn2,trains.a2[,3:4],3)[,2:12]
#dlt_tests.a2<-dlt.convert(tests.a2$tsn2,tests.a2[,3:4],3)[,2:12]
#dlt_trains.a3<-dlt.convert(trains.a3$trn2,trains.a3[,3:4],3)[,2:12]
#dlt_tests.a3<-dlt.convert(tests.a3$tsn2,tests.a3[,3:4],3)[,2:12]
#dlt_trains.a4<-dlt.convert(trains.a4$trn2,trains.a4[,3:4],3)[,2:12]
#dlt_tests.a4<-dlt.convert(tests.a4$tsn2,tests.a4[,3:4],3)[,2:12]
#dlt_trains.a5<-dlt.convert(trains.a5$trn2,trains.a5[,3:4],3)[,2:12]
#dlt_tests.a5<-dlt.convert(tests.a5$tsn2,tests.a5[,3:4],3)[,2:12]
n=300
#A1:
...
#Convert
#dlt_trains.b<-Matrix::sparse.model.matrix(trn1+trn2 ~ .-1, data = trains.b)
#dlt_tests.b<-Matrix::sparse.model.matrix(tsn1+tsn2 ~ .-1, data = tests.b)
#dlt_trains.b<-dlt.convert(trains.b$trn2,trains.b[,3:6],2)[,2:13]
#dlt_tests.b<-dlt.convert(tests.b$tsn2,tests.b[,3:6],2)[,2:13]
dlt_trains.b<-dlt.convert(trains.b$trn2,trains.b[,3:6],3)[,2:25]
dlt_tests.b<-dlt.convert(tests.b$tsn2,tests.b[,3:6],3)[,2:25]
n=200
#B1:
bst.b1 <- xgboost(data = dlt_trains.b,label = results$b1,nrounds = n)
p.b1 <- predict(object = bst.b1,newdata = t(dlt_tests.b))
#B2:
bst.b2 <- xgboost(data = dlt_trains.b,label = results$b2,nrounds = n)
p.b2 <- predict(object = bst.b2,newdata = t(dlt_tests.b))

result.a<-c(p.a1,p.a2,p.a3,p.a4,p.a5)
result<-c(sort(result.a),p.b1,p.b2)
result
plot(result)
