dlt.BNFII <- function(data,count) {
  ...
  tests.a11<-data.frame(a1.2,a1.1)
  tests.a22<-data.frame(a2.2,a2.1)
  tests.a33<-data.frame(a3.2,a3.1)
  tests.a44<-data.frame(a4.2,a4.1)
  tests.a55<-data.frame(a5.2,a5.1)
  #B:
  b1.1<-tests_1$b1
  b2.1<-tests_1$a2
  b1.2<-tests_2$b1
  ...
  tests.b11<-data.frame(b1.2,b1.1)
  tests.b22<-data.frame(b2.2,b2.1)
  #BN logistic testsuit
  p.a11 <- predict(object = fit_bn.a11,tests.a11,node = "resa1")
  p.a22 <- predict(object = fit_bn.a22,tests.a22,node = "resa2")
  p.a33 <- predict(object = fit_bn.a33,tests.a33,node = "resa3")
  p.a44 <- predict(object = fit_bn.a44,tests.a44,node = "resa4")
  p.a55 <- predict(object = fit_bn.a55,tests.a55,node = "resa5")
  p.b11 <- predict(object = fit_bn.b11,tests.b11,node = "resb1")
  p.b22 <- predict(object = fit_bn.b22,tests.b22,node = "resb2")
  
  
  result<-c(p.a11,p.a22,p.a33,p.a44,p.a55,p.b11,p.b22)
  barplot(result,main = "BNFII")
  return(result)
