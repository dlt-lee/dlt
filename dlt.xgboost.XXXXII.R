...
dlt.xgboost.XXXXII <- function(data,count,n) {
  ...
  tests.T.a1<-Matrix(as.matrix(tests.a1[,4:297]),sparse=T)
  tests.T.a2<-Matrix(as.matrix(tests.a2[,4:297]),sparse=T)
  tests.T.a3<-Matrix(as.matrix(tests.a3[,4:297]),sparse=T)
  tests.T.a4<-Matrix(as.matrix(tests.a4[,4:297]),sparse=T)
  tests.T.a5<-Matrix(as.matrix(tests.a5[,4:297]),sparse=T)
  tests.T.b1<-Matrix(as.matrix(tests.b1[,4:297]),sparse=T)
  tests.T.b2<-Matrix(as.matrix(tests.b2[,4:297]),sparse=T)
