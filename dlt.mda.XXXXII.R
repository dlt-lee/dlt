data<-dlt
count<-dim(dlt)[1]
dlt.mda.XXXXII <- function(data,count) {
  library(mda)
  library(caret)
  ...
  mdaModel.a1<-mda(resa1~
                     a1.1+a2.1+a3.1+a4.1+a5.1+b1.1+b2.1+
                     a1.2+a2.2+a3.2+a4.2+a5.2+b1.1+b2.1+
                     a1.3+a2.3+a3.3+a4.3+a5.3+b1.1+b2.1+
                     a1.4+a2.4+a3.4+a4.4+a5.4+b1.1+b2.1+
                     a1.5+a2.5+a3.5+a4.5+a5.5+b1.1+b2.1+
                     a1.6+a2.6+a3.6+a4.6+a5.6+b1.1+b2.1+
                     a1.7+a2.7+a3.7+a4.7+a5.7+b1.1+b2.1+
                     a1.8+a2.8+a3.8+a4.8+a5.8+b1.1+b2.1+
                     a1.9+a2.9+a3.9+a4.9+a5.9+b1.1+b2.1+
                     
                     a1.10+a2.10+a3.10+a4.10+a5.10+b1.10+b2.10+
                     a1.11+a2.11+a3.11+a4.11+a5.11+b1.11+b2.11+
                     a1.12+a2.12+a3.12+a4.12+a5.12+b1.12+b2.12+
                     a1.13+a2.13+a3.13+a4.13+a5.14+b1.13+b2.13+
                     a1.14+a2.14+a3.14+a4.14+a5.14+b1.14+b2.14+
                     a1.15+a2.15+a3.15+a4.15+a5.15+b1.15+b2.15+
                     a1.16+a2.16+a3.16+a4.16+a5.16+b1.16+b2.16+
                     a1.17+a2.17+a3.17+a4.17+a5.17+b1.17+b2.17+
                     ...
                     a1.20+a2.41+a3.41+a4.41+a5.41+b1.41+b2.41+
                     a1.21+a2.40+a3.40+a4.40+a5.40+b1.40+b2.40+
                     a1.22+a2.41+a3.41+a4.41+a5.41+b1.41+b2.41+
                     a1.23+a2.40+a3.40+a4.40+a5.40+b1.40+b2.40+
                     a1.24+a2.41+a3.41+a4.41+a5.41+b1.41+b2.41+
                     a1.25+a2.40+a3.40+a4.40+a5.40+b1.40+b2.40+
                     a1.26+a2.41+a3.41+a4.41+a5.41+b1.41+b2.41+
                     a1.27+a2.40+a3.40+a4.40+a5.40+b1.40+b2.40+
                     a1.28+a2.41+a3.41+a4.41+a5.41+b1.41+b2.41+
                     a1.29+a2.40+a3.40+a4.40+a5.40+b1.40+b2.40+
                     
                     a1.30+a2.41+a3.41+a4.41+a5.41+b1.41+b2.41+
                     a1.31+a2.40+a3.40+a4.40+a5.40+b1.40+b2.40+
                     a1.32+a2.41+a3.41+a4.41+a5.41+b1.41+b2.41+
                     a1.33+a2.40+a3.40+a4.40+a5.40+b1.40+b2.40+
                     a1.34+a2.41+a3.41+a4.41+a5.41+b1.41+b2.41+
                     a1.35+a2.40+a3.40+a4.40+a5.40+b1.40+b2.40+
                     a1.36+a2.41+a3.41+a4.41+a5.41+b1.41+b2.41+
                     a1.37+a2.40+a3.40+a4.40+a5.40+b1.40+b2.40+
                     a1.38+a2.41+a3.41+a4.41+a5.41+b1.41+b2.41+
                     a1.39+a2.40+a3.40+a4.40+a5.40+b1.40+b2.40+
