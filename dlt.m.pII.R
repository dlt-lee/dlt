          ...
          for(k in 1:l.a44)
            if(p.a44[k,1]>p.a33[g,1]) {
              for(h in 1:l.a55) {
                ...
                #b.final.data<-b.data.f[which(b.p>(lr/p.a) & b.p<(hr/p.a)),]
                b.final.data<-b.data.m[(b.data.m[,3]>(lr/p.a)&b.data.m[,3]<(hr/p.a)),]
                #print(b.final.data)
                r.b<-dim(b.final.data)[1]
                if(is.null(r.b)) {
                  ab.temp<-c(a.temp[1],a.temp[2],a.temp[3],a.temp[4],a.temp[5],
                             b.final.data[1],b.final.data[2],p.a,b.final.data[3],
                             sum(a.temp[1],a.temp[2],a.temp[3],a.temp[4],a.temp[5]),
                             sum(b.final.data[1],b.final.data[2]),
                             p.a*b.final.data[3])
                  print(c(a.temp[1],a.temp[2],a.temp[3],a.temp[4],a.temp[5],
                          b.final.data[1],b.final.data[2]))
                  ab.data<-c(ab.data,ab.temp)
                  
                }else if(r.b!=0) {
                  for(q in 1:r.b) {
                    ab.temp<-c(a.temp[1],a.temp[2],a.temp[3],a.temp[4],a.temp[5],
                               b.final.data[q,1],b.final.data[q,2],p.a,b.final.data[q,3],
                               sum(a.temp[1],a.temp[2],a.temp[3],a.temp[4],a.temp[5]),
                               sum(b.final.data[q,1],b.final.data[q,2]),
                               p.a*b.final.data[q,3])
                    print(c(a.temp[1],a.temp[2],a.temp[3],a.temp[4],a.temp[5],
                            b.final.data[q,1],b.final.data[q,2]))
                    ab.data<-c(ab.data,ab.temp)
                  }
                }
...
ab.f<-ab.data.f[which(
  (sa>=63&sa<=133)&
    ...
    (a4==6|a4==8|a4==9|a2==10|a4==11|a4==12|a4==13|a4==14|a4==15|a4==16|a4==17|a4==18|a4==19|a4==20|a4==21|a4==22|a4==23|a4==24|a4==25|a4==26|a4==27|a4==28|a4==29|a4==30|a4==31|a4==32|a4==33|a4==34)&
    (a5==14|a5==15|a5==16|a2==17|a5==18|a5==19|a5==20|a5==21|a5==22|a5==23|a5==24|a5==25|a5==26|a5==27|a5==28|a5==29|a5==30|a5==31|a5==32)&
    (b1==1|b1==2|b1==3|b1==4|b1==5|b1==6|b1==7|b1==8|b1==9|b1==10|b1==11)&
    (b2==2|b2==3|b2==4|b2==5|b2==6|b2==7|b2==8|b2==9|b2==10|b2==11|b2==12)&
...
a.data.f[which(a11==4&a22==9&a33==23&a44==24&a55==30),]
b.data.f[which(b11==8&b22==11),]
