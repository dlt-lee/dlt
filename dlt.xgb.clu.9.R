dlt.xgb.clu.9<-function(trains,d_o) {
  ...
  bst.b1<-xgboost(data = trains.T[,c(6,13,20,27,34,41,48,55,62)],label = trains$res.b1,nrounds = 300,print_every_n = 300L)
  bst.b2<-xgboost(data = trains.T[,c(7,14,21,28,35,42,49,56,63)],label = trains$res.b2,nrounds = 300,print_every_n = 300L)
