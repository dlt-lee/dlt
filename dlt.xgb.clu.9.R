dlt.xgb.clu.9<-function(trains,d_o) {
  ...
  bst.a1<-xgboost(data = trains.T[,c(1,8,15,22,29,36,43,50,57)],label = trains$res.a1,nrounds = 300,print_every_n = 300L,params = list(tree_method = 'gpu_hist'))
  ...
  bst.b2<-xgboost(data = trains.T[,c(7,14,21,28,35,42,49,56,63)],label = trains$res.b2,nrounds = 300,print_every_n = 300L,params = list(tree_method = 'gpu_hist'))
