...
sort(table(c(r9[1],r10[1],r11[1],r12[1],r13[1],r14[1])))
sort(table(c(r9[2],r10[2],r11[2],r12[2],r13[2],r14[2])))
sort(table(c(r9[3],r10[3],r11[3],r12[3],r13[3],r14[3])))
sort(table(c(r9[4],r10[4],r11[4],r12[4],r13[4],r14[4])))
sort(table(c(r9[5],r10[5],r11[5],r12[5],r13[5],r14[5])))
sort(table(c(r9[6],r10[6],r11[6],r12[6],r13[6],r14[6])))
sort(table(c(r9[7],r10[7],r11[7],r12[7],r13[7],r14[7])))
